...
<link href="<%=request.getContextPath() %>/static/${clientInfo.cssFileName}?version=1.4" rel="stylesheet" >
...
<div id="page">
  <div class="page_container">
    ...
    <div class="page_header" id="pageHeaderDivId">
	  ...
	  <input type="button"  id="viewResvDtlsBtn" value="${clientInfo.viewExistingResvLabel}" class="float_right logout" onclick="onViewExtResvDtlsClick();">
    ...
    <input type="hidden" id="login_first" value="N"/>
    ...
    <div id="leftCont">
      <div id="accordion">
        ...
        <h3 class="ui-header ui-state-active"> <span  class="ui-accordion-header-icon ui-icon-triangle-1-s"></span>${clientInfo.leftSideResvDetailsHeader}</h3>
        <div id="cont1" class="ui-content">
		
		<!-- Reservation Left JSP PAGE -->
		<%@ include file="reservation_left_section.jsp"%>
        ...
        <h3 class="ui-header ui-state-default"> <span class="ui-accordion-header-icon ui-icon-triangle-1-e"></span>${clientInfo.leftSideLoginHeader}</h3>
    ...
    <div id="righCont">
      ...
      <div id="firstMsg" class="active">
		...
		<!-- Reservation Details Right JSP PAGE -->
		<%@ include file="reservation_right_section.jsp"%>	
